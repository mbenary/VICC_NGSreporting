...
```{r institutes, fig.width=40, fig.height=20, fig.cap=paste("Histogram of participant work settings at a clinical, commercial, and/or academic setting.")}
...
```{r plotTumortypes, fig.width=40, fig.height=20}
